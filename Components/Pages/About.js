...
const About = () => {
  return (
    <div>
      <section className="bg-white mt-10 py-20 xl:px-32 lg:py-[120px] overflow-hidden relative z-10">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">
                      Main Street, Kuttikkarachi, Kinniya 31100, Trincomalee
                      District.
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">+94767313385</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white transition border rounded border-primary bg-black hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
